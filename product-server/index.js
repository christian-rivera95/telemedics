...
app.get('/users/add', (req, res) => {
    const { username, userpassword, idroles } = req.query;
    const INSERT_USERS_QUERY = `INSERT INTO users (username,userpassword,idroles) VALUES(${username}, ${userpassword}, ${idroles})`;
